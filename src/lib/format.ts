 ...
 * "4.6 GB" for the multi-gigabyte local-LLM GGUF presets). The unit is a
 * universal symbol, not translatable prose; the surrounding "approximately"
 * wording comes from i18n. Non-finite/negative inputs render as "0 B" rather
 * than throwing.
 */
