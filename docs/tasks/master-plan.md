...
| Phase | Goal | Status |
|-------|------|--------|
| 0 | Foundation: toolchain, app skeleton, CI green, full specs written | Active |
| 1 | Region-translate MVP (FR-02 + minimal FR-03/FR-04): select region -> OCR -> translate -> preview overlay, keys in keychain | Planned |
...
| TASK-004 | CI pipeline green on the skeleton (lint + cargo test + vitest + build) | devops | TASK-002 | P1 | 0 | Active |
...
| TASK-008 | Region-select overlay + translation preview UI | frontend-ui-dev | TASK-002 | P0 | 1 | Planned |
