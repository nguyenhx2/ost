...
| 2026-07-28 | orchestrator | DDD agent-harness rebuild: `screen-translate-dev` retired, ownership carries to `recognition-dev` (Recognition context owns `ocr/`, `docs/architecture/domain-model.md`). Owner field updated; still parked. | Pending |
